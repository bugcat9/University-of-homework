...
sys.argv=[sys.argv[0],'-sSender.py','-rReceiver.py']
"""
...
def tests_to_run(forwarder):
    ...
    BasicTest.BasicTest(forwarder, "1.jpg")
    #RandomDropTest.RandomDropTest(forwarder, "README") 
    #RandomDropTest.Drop2Test(forwarder, "README")
    #RandomDropTest.unsoredTest(forwarder, "README")
...
class Forwarder(object):
    ...
    def __init__(self, sender_path, receiver_path, port):
        ...
        self.timeout =10000 # seconds

        # network stuff
        self.port = port
        self.sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        self.sock.settimeout(3) # make this a very short timeout, por que no?
    ...
    def start(self, input_file):
        ...
        #self.recv_outfile=input_file #this should write the file name
        self.in_queue = []
        self.out_queue = []
