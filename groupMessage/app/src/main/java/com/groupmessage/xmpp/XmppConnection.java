...
public class XmppConnection {
    ...
    public static int PORT = 5222;   //服务器端口号

    public static  String IP = "106.54.254.135";  //服务器ip

    public static String SERVER_NAME = "106.54.254.135";// 域

    private static XMPPConnection connection ;

    private static FileTransferManager fileManager;     //用于文件发送

    private static MultiUserChat multiUserChat;     //用于群聊
