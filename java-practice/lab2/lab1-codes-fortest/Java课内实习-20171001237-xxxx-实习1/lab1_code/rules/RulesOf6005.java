...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if(availableToOthers==true&&writtenByYourself==false&&writtenAsCourseWork==false&&citingYourSource==false&&implementationRequired==false)
        	return false;
        else if(availableToOthers==false&&writtenByYourself==true&&writtenAsCourseWork==true&&citingYourSource==true&&implementationRequired==true)
        	return true;
        else
